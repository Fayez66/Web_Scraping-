...
from AllData.functions import translate_with_cache, classify_job
...
for split in splits:
    ...
    for page in range(1,2):
        ...
        df.to_csv(r"Freelancer.csv", index=False, encoding="utf-8-sig")
...
job_df.to_csv("Freelancer.csv", index=True, encoding="utf-8-sig")
...
decs_df.to_csv("FreelancerSkills.csv", index=True, encoding="utf-8-sig")