from AllData.functions import classify_job, process_file, extract_and_convert_budget, translate_with_cache
...
# --- Save to CSV ---
df.to_csv("FreelanceYard.csv", index=False, encoding="utf-8-sig")
