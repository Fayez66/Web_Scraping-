from AllData.functions import classify_job, extract_numbers, process_file, parse_posted_date
...
for category in categories:
    ...
    for page in range(1, 2):  # you can increase this safely now
        ...
        df.to_csv("UpWork.csv", index=False, encoding="utf-8-sig")
...
Tags.to_csv("UpWorkSkills.csv", index=True, encoding="utf-8-sig")
